...
struct ThemeChooserView: View {
    ...
    @State private var presentThemeEditor = false
    ...
    var body: some View {
        NavigationView {
            ...
            .popover(isPresented: $presentThemeEditor) {
                ThemeEditor(theme: Theme(name: "New", emojis: "", color: .blue, id: 0))
            }
